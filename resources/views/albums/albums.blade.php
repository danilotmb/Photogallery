            ...
            @foreach($albums as $album)
                <tr id="tr{{$album->id}}" class="align-middle">
                    ...
                    <td>
                        <div class="row g-0">
                            <div class="col-md-3">
                                <a title="Add new image" href="{{route('photos.create')}}?album_id={{$album->id}}" class="btn btn-primary" data-album-id="{{$album->id}}">
                            ...
                            <div class="col-md-3">
                                ...
                                @else
                                    <a id="empty-album" class="btn btn-primary" onclick="showAlert()"><i class="bi-image"></i></a>
                                @endif
                            </div>
                            <div class="col-md-3">
...
@section('footer')
    ...
    <script>
        $('document').ready(function () {
            ...
            $('table').on('click', 'a#empty-album', function (evt) {
                evt.preventDefault();
                showAlert();
            });
        });
